...
## Риск: публикация и монетизация из России

Перед публичной монетизацией нужно отдельно проверить юридико-финансовую реализуемость:

- доступность Apple Developer Program для владельца аккаунта;
- возможность оплаты $99/год;
- доступность Paid Apps Agreement;
- прохождение tax forms в App Store Connect;
- доступность банковских выплат Apple на выбранный банк;
- SWIFT/санкционные/региональные ограничения;
- налоговые обязательства в стране резидентства.

Это не блокирует MVP v0.2, но является блокером перед v1.0/App Store monetization.
